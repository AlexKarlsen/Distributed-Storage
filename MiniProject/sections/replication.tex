...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{|X|X|X|X|X|}
        \hline
        \cellcolor{lightgray}\textbf{Size} & \cellcolor{lightgray}\textbf{Time Case A [s] (k=2)} & \cellcolor{lightgray}\textbf{Time Case A [s] (k=3)} & \cellcolor{lightgray}\textbf{Time Case B [s] (k=2)} & \cellcolor{lightgray}\textbf{Time Case B [s] (k=3)} \\\hline
        10KB  & 0.21    & 0.36   & 0.17   & 0.16   \\\hline
        100KB & 0.46    & 0.48   & 0.18   & 0.20   \\\hline
        1MB   & 1.65    & 2.21   & 1.31   & 1.02   \\\hline
        10MB  & 14.31   & 20.04  & 9.59   & 10.02  \\\hline
        100MB & 144.59  & 203.57 & 109.72 & 111.74 \\\hline
    \end{tabularx}
